...
async def main():
    ...
    # 4 concurrent tasks — conservative to avoid HTTP 429 rate limits from Fireworks AI.
    # This is lower than before to prevent rate-limit failures that caused accuracy drops.
